#pragma once
#include<iostream>
#include <queue> // added to use std::queue (fixes compile error: 'queue' does not name a type)
#include <stack> // added to use std::stack (fixes compile error: 'stack' does not name a type)
